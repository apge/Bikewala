...
public class AllUsersActivity extends ListActivity {
    ...
    private static String url_all_users = "http://10.0.2.2/bikewala/viewAllUsers.php";
	...
	protected String doInBackground(String... args) {
	    ...
	    JSONObject json = jParser.makeHttpRequest(url_all_users, "GET",
		    params);
	...
	protected void onPostExecute(String file_url) {
		...
		public void run() {
		    ...
		    ListAdapter adapter = new SimpleAdapter(
			    ...
			    R.layout.list_user, new String[] { TAG_PID,
				    TAG_NAME },
